...
<div class="col-md-6 col-sm-6" style="margin-bottom:10px">
  <div class="testo-bianco text-center box-hot-notizia-top"><i class="fa fa-fire"></i> Nome notizia</div>
  <div class="card sb-3 box-shadow">
    ...
    <div class="row">
      <div class="col-sm-6"><div class="colore-sfondo-primario testo-bianco text-center box-hot-notizia-info"><i class="fa fa-folder"></i> : Crypto</div></div>
      <div class="col-sm-6"><div class="testo-bianco text-center box-hot-notizia-info"><i class="fa fa-user"></i> : Andres</div></div>
    </div>
    <div class="card-body">
